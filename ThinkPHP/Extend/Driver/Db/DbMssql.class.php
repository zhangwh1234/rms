...
/***
* http://127.0.0.1/newrmstest/litter.php?s=/TranTeltoRms.html
*/
/**
...
class DbMssql extends Db{
   protected $selectSql  =     'SELECT%DISTINCT% %LIMIT% %FIELD% FROM %TABLE%%JOIN%%WHERE%%GROUP%%HAVING%%ORDER% %UNION%';
    /**
     * 架构函数 读取数据库配置信息
     * @access public
     ...
     * @return string
     */
    public function parseLimit($limit) { return " top ".$limit;    }
    public function parseLimit11($limit) {
