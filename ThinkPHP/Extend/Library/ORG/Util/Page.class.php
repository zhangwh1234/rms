...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制	
	protected $config  =	array('header'=>'条记录','prev'=>'&laquo; 上一页','next'=>'下一页 &raquo;','first'=>'首页','last'=>'末页','theme'=>' <ul class="pagesul"><li><span>共%totalRow% %header% %nowPage%/%totalPage% 页</span></li><li><ul><li>%first%</li><li>%upPage%</li><li>%linkPage%</li><li>%downPage%</li><li>%end%</li></ul></li><li><ul><li>跳转至第</li><li>%go%</li><li>页</li></ul></li></ul>');
    // 默认分页变量名
    public $varPage;
