...
class Page {
    ...
    public function show() {
        ...
        /* 更改 */
		if ($upRow>0){
             $upPage     =   "<a href='#' onclick='updateTab(&apos;".str_replace('__PAGE__',$upRow,$url)."&apos;)'>".$this->config['prev']."</a>";
             $theFirst   =   "<a href='#' onclick='updateTab(&apos;".str_replace('__PAGE__',1,$url)."&apos;)' >".$this->config['first']."</a>";
        ...
        if ($downRow <= $this->totalPages){
            $theEndRow  =   $this->totalPages;
             $downPage   =   "<a href='#' onclick='updateTab(&apos;".str_replace('__PAGE__',$downRow,$url)."&apos;)'>".$this->config['next']."</a>";
            $theEnd     =   "<a href='#' onclick='updateTab(&apos;".str_replace('__PAGE__',$theEndRow,$url)."&apos;)' >".$this->config['last']."</a>";
        }elseif (1 < $this->totalPages){
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                if($page<=$this->totalPages){
                    $linkPage .= "&nbsp;<a href='#' onclick='updateTab(&apos;".str_replace('__PAGE__',$page,$url)."&apos;)'>&nbsp;".$page."&nbsp;</a>";                    
                }else{
                    break;
                }
            }else{
