...
class YingshouOrderSearchModel extends CRMEntityModel
{
    protected $tableName = 'orderform';
    //指定焦点字段
    public $fieldsFocus = 'address';
    //定义列表
    ...
    //定义查询字段
    public $searchFields = array('address', 'telphone', 'sendname', 'company', 'ordersn');
    //定义选择产品编码的字段
    public $popupProductsFields = array('code', 'name', 'price', 'brief');
    //定义焦点产品选择的字段
    public $popupProductsLinkField = 'name';
