...
class GeneralReportAction extends ModuleAction
{
    ...
    private function tongjiOrderSendtime($reporttype, $where)
    {
        ...
        $tongjisendtimeResult = $tongjisendtimeModel->field($fields)
            ->where($where)
            ->group('company')
            ->order('id desc')
            ->select();
    ...
    /**
     * 财务系统的统计报表
     * http://cz.lihua.com/index.php?s=/GeneralReport/actionTongjiFinance.html
     */
    public function actionTongjiFinance()
    {

        $dnsConnectionDB = 'mysql://rootlihua:zhangwh0731@rdsq6jvauvez7rq618.mysql.rds.aliyuncs.com:3306/bjrms_2019';
        $dnsConnection = 'mysql://rootlihua:zhangwh0731@rdsq6jvauvez7rq618.mysql.rds.aliyuncs.com:3306/bjrms';
        ...
        $orderformModel_2018 = M('orderform_06', 'rms_', $dnsConnectionDB);
