<?php if (!defined('THINK_PATH')) exit();?><table id="table<?php echo ($actionName); ?>" border="1" cellspacing="1" cellpadding="3" width="100%" class="lvt" align="center">
    <tr class="listHeader">
        ...
        <td class="listHeader" width="20%">客户名称</td>
        <td class="listHeader" width="10%">金额</td>
        <td class="listHeader" width="10%">类型</td>
        <td class="listHeader" width="10%">日期</td>
        <td class="listHeader" width="10%">午别</td>
