<?php if (!defined('THINK_PATH')) exit();?><div class="moduleMenu">
    <ul>
        ...
        <li style="margin-left: 10px;"><a href="javascript:void(0);" onclick="YingshouRoomServiceListviewModule.createview();"><img src=".__PUBLIC__/Images/newBtn.png" alt="" title="" border="0"></a>
        </li>
...
<script>
    var YingshouRoomServiceListviewModule = {
        ...
        checkorder: function (name, rowIndex, date, ap) {
            //关闭定时
            clearInterval(this.referListview);
        ...
        refreshListview: function () {
            ...
            this.referListview = setInterval(function () {
                $.ajax({
                    type: "POST",
                    url: "__URL__/listview",
                    dataType: "json",
                    ...
                    success: function (data) {
                        if (data.rows.length > 0) {
                            //选择第一行焦点
                            $('#yingshouroomservice_index_datagrid').datagrid('loadData', data);
                        }
                    }
                })
            }, 60000);
        ...
        calculateOrder: function () {
            var that = this;
            this.calculateRoom = setInterval(function () {
                //获取日期
                var room_date = $('#roomservicebillCreateviewDateInput').datebox('getValue'); //
                var room_ap = $('#roomservicebillCreateviewApInput').val();
                var data = {
                    'room_date': room_date,
                    'room_ap': room_ap
                };
        ...
        closeTab: function () {
            ...
            //关闭定时
            clearInterval(this.referListview);
            clearInterval(this.calculateRoom);
        }
    }
    ...
    $(function () {
        ...
        setTimeout(function () {
            ...
            YingshouRoomServiceListviewModule.refreshListview();
        }, 600)
    })
</script>