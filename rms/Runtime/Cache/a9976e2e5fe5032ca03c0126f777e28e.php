...
<script type="text/javascript">
    ...
    var YingshouWorklunchPopupAccountsviewModule = {
        ...
        operate: function (val, rowData, rowIndex) {
            var btn = [];
            btn.push('<a href="javascript:void(0);" onclick="YingshouWorklunchPopupAccountsviewModule.selectProducts(' + rowData.productsid+','+rowData.code+',\''
