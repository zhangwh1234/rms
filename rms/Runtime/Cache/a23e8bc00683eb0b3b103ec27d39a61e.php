<?php if (!defined('THINK_PATH')) exit();?><script type="text/javascript">
	$(function() {
		...
		$("#reportViewForm<?php echo ($moduleName); echo ($action); ?>").form({
			url : "__URL__/showReport/reporttype/<?php echo ($reporttype); ?>",
			type : "get",
			onSubmit : function() {
				//进行表单验证   
				//如果返回false阻止提交 
			...
			success : function(data) {
				$('#list<?php echo ($moduleName); ?>').html(data);
			}
		});

		$('#reportViewBtn').bind('click', function() {
			//提交表单   
			$("#reportViewForm<?php echo ($moduleName); echo ($action); ?>").submit();
...
<div class="searchDiv" style="clear: both;">
	<form id="reportViewForm<?php echo ($moduleName); echo ($action); ?>"
		name="reportViewForm<?php echo ($moduleName); echo ($action); ?>" method="post"
