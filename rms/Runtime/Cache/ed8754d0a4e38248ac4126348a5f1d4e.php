...
<?php if(($uitype == 0)): ?><td width=20% class="dvtCellLabel" align=right><font color="red"><?php echo ($mandatory_field); ?></font><?php echo ($label); ?></td>
    ...
    <td width="100%" class="dvtCellLabel" align=center colspan="4">
        <table id="telAddressTable" width="90%" border=0 style="border: 1px solid #e0dddd; margin-top: 2px;"
            ...
            <?php if(empty($teladdress)): $__FOR_START_1160898263__=1;$__FOR_END_1160898263__=4;for($key=$__FOR_START_1160898263__;$key < $__FOR_END_1160898263__;$key+=1){ ?><tr style="height:25px;border: 1px solid black;background: #F0F0F0;" class="CaseRow">
...
<table id="<?php echo ($moduleName); echo (ucfirst(ACTION_NAME)); ?>productsTable" style="BORDER-COLLAPSE: collapse"  borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderproducts)): $__FOR_START_2126513934__=0;$__FOR_END_2126513934__=3;for($key=$__FOR_START_2126513934__;$key < $__FOR_END_2126513934__;$key+=1){ ?><tr>
...
<table id="orderPrintHandleTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderPrintHandle)): $__FOR_START_1389856242__=0;$__FOR_END_1389856242__=30;for($key=$__FOR_START_1389856242__;$key < $__FOR_END_1389856242__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
...
<script>
    var ProductsCreateviewModule = {
        ...
        //保存记录
        insert: function () {
            $('#ProductsCreateviewForm').form('submit', {
                url: '__URL__/insert',
                onSubmit: function () {
                    var isValid = $(this).form('validate');
                    if (!isValid) {
        ...
        quickKeyboardAction: function () {
            ...
            Mousetrap.bind(['ctrl+9', 'ctrl+f9', 'f9'], function (e) {
                ...
                if (tabOptions.title == '产品' && ($('#ProductsAction').val() == 'Createview')) {
                    ProductsCreateviewModule.insert();
                };
            });
    ...
    $(function () {
        ProductsCreateviewModule.init();
        setTimeout(function(){
            $('#ProductsCreateviewForm input[name=code]').focus();
        },100);
