...
<div class="moduleoperator">
    <form id="YingshouDoorBillCreateviewForm" name="<?php echo ($moduleName); ?>CreateviewForm" method="post" style="border:1px solid white;margin-top: 0px;">
...
<?php if(($uitype == 0)): ?><td width=20% class="dvtCellLabel" align=right><font color="red"><?php echo ($mandatory_field); ?></font><?php echo ($label); ?></td>
    ...
    <td width="100%" class="dvtCellLabel" align=center colspan="4">
        <table id="telAddressTable" width="90%" border=0 style="border: 1px solid #e0dddd; margin-top: 2px;"
            ...
            <?php if(empty($teladdress)): $__FOR_START_659821763__=1;$__FOR_END_659821763__=4;for($key=$__FOR_START_659821763__;$key < $__FOR_END_659821763__;$key+=1){ ?><tr style="height:25px;border: 1px solid black;background: #F0F0F0;" class="CaseRow">
...
<table id="<?php echo ($moduleName); echo (ucfirst(ACTION_NAME)); ?>productsTable" style="BORDER-COLLAPSE: collapse"  borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderproducts)): $__FOR_START_2005165036__=0;$__FOR_END_2005165036__=3;for($key=$__FOR_START_2005165036__;$key < $__FOR_END_2005165036__;$key+=1){ ?><tr>
...
<table id="orderPrintHandleTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderPrintHandle)): $__FOR_START_102298425__=0;$__FOR_END_102298425__=30;for($key=$__FOR_START_102298425__;$key < $__FOR_END_102298425__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
...
<table id="YingshouDoorBillAccountsTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%" align="center" border="1">
    ...
    <?php if(empty($doorbillaccounts)): $__FOR_START_1520347275__=0;$__FOR_END_1520347275__=3;for($key=$__FOR_START_1520347275__;$key < $__FOR_END_1520347275__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
                <td width="10%" align="center"> 
    ...
    var accountsAjax = false; //判断是否查询过产品代码，防止在ajax中按回车，反复执行，有个alert的小bug
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icons-other-tick'" onclick="<?php echo ($moduleName); ?>CreateviewModule.insert();" style="width:100px;margin-right:40px;">确认</a>
...
<input id="YingshouDoorBillAction" type="hidden" value="Createview"/>

<script>
    var YingshouDoorBillCreateviewModule = {
        ...
        //保存记录
        insert: function () {
            $('#YingshouDoorBillCreateviewForm').form('submit', {
                url: '__URL__/insert',
                onSubmit: function () {
                    //进行表单验证
                    if($('#code').val() == ''){
    ...
    $(function () {
        ...
        YingshouDoorBillCreateviewModule.init();
        //$('#YingshouDoorBillCreateviewForm input[name=money]').focus();
$("#YingshouDoorBillAccountsCode_1" ).focus();
    })
</script>