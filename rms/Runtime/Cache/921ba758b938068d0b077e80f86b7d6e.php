...
<div class="moduleoperator">
    <form id="YingshouWorklunchCreateviewForm" name="<?php echo ($moduleName); ?>CreateviewForm" method="post"
...
<?php if(($uitype == 0)): ?><td width=20% class="dvtCellLabel" align=right><font color="red"><?php echo ($mandatory_field); ?></font><?php echo ($label); ?></td>
    ...
    <td width="100%" class="dvtCellLabel" align=center colspan="4">
        <table id="telAddressTable" width="90%" border=0 style="border: 1px solid #e0dddd; margin-top: 2px;"
            ...
            <?php if(empty($teladdress)): $__FOR_START_1306129077__=1;$__FOR_END_1306129077__=4;for($key=$__FOR_START_1306129077__;$key < $__FOR_END_1306129077__;$key+=1){ ?><tr style="height:25px;border: 1px solid black;background: #F0F0F0;" class="CaseRow">
...
<table id="<?php echo ($moduleName); echo (ucfirst(ACTION_NAME)); ?>productsTable" style="BORDER-COLLAPSE: collapse"  borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderproducts)): $__FOR_START_360761569__=0;$__FOR_END_360761569__=3;for($key=$__FOR_START_360761569__;$key < $__FOR_END_360761569__;$key+=1){ ?><tr>
...
<table id="orderPrintHandleTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderPrintHandle)): $__FOR_START_1022901934__=0;$__FOR_END_1022901934__=30;for($key=$__FOR_START_1022901934__;$key < $__FOR_END_1022901934__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
...
<table id="YingshouWorklunchAccountsTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0"
    ...
    <?php if(empty($worklunchaccounts)): $__FOR_START_10523340__=0;$__FOR_END_10523340__=3;for($key=$__FOR_START_10523340__;$key < $__FOR_END_10523340__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
                <td width="10%" align="center"> 
...
<script type="text/javascript">
    //指定某个字段获得焦点
    $(function () {
        $("#<?php echo ($moduleName); ?>CreateViewForm #<?php echo ($fieldsFocus); ?>").focus();
    });
