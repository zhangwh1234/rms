<?php if (!defined('THINK_PATH')) exit();?><div class="moduleMenu">
    <ul>
        ...
        <li><a href="javascript:void(0);"  onclick="IndexIndexModule.updateOperateTab('__URL__/<?php echo ($returnAction); ?>/pagetype/<?php echo ($pagetype); ?>/rowIndex/<?php echo ($rowIndex); ?>');">放弃;返回列表</a></li>
    ...
    <td width=30% align=left class="dvtCellInfo">
        <span><?php echo ($value); ?></span>
                        ...
                        <tr>
                            ...
                            <td> 
                                <input title="" accessKey="" class="crmbutton small cancel" onclick="updateTab('__APP__/<?php echo ($moduleName); ?>/cancel/record/<?php echo ($record); ?>')" type="button" name="button" value="  <?php echo (L("Button_Cancel")); ?>  "  style="width:70px;float:left;margin-left:2px;margin-top:2px;margin-bottom:2px;"></td>
                            <td> 
                            </td>
                        </tr>
                    </table>
    ...
    var OrderDistributionCancelviewModule = {
        ...
        cancel: function () {
            ...
            $.messager.confirm('确认', '是否真的需要作废?', function (r) {
                if (r) {
                    $.ajax({
                        type: "GET",
                        url: "__URL__/cancel/returnAction/<?php echo ($returnAction); ?>/record/<?php echo ($record); ?>/pagetype/<?php echo ($pagetype); ?>/rowIndex/<?php echo ($rowIndex); ?>",
                        dataType: "json",
        ...
        quickKeyboardAction: function () {
            ...
            Mousetrap.bind(['ctrl+4', 'ctrl+f4', 'f4'], function (e) {
                ...
                IndexIndexModule.updateOperateTab("__URL__/<?php echo ($returnAction); ?>/<?php echo ($pagetype); ?>/rowIndex/<?php echo ($rowIndex); ?>");
                //};
            });
        }
    }
