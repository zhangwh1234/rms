<?php if (!defined('THINK_PATH')) exit();?><script type="text/javascript">
    ...
    function outputTongjiExcel() {
        var reportSerialize = $("#reportViewForm<?php echo ($moduleName); echo ($action); ?>")
            .serialize();
        document.location.href = '__URL__/outputTongjiExcel/reporttype/<?php echo ($reporttype); ?>'
            + '&' + reportSerialize;
    }
...
<div class="searchDiv" style="clear: both;">
    <form id="reportViewFormHuizong"
          name="reportViewFormHuizong" method="post"
        ...
        <ul class="searchOption">
            ...
            <li><input id="reportStartDate" name="reportStartDate"
                       type="text" style="width: 150px" value="<?php echo ($reportStartValue); ?>"
                       AUTOCOMPLETE="off" /></li>
            <li>结束日期</li>
            <li><input id="reportEndDate" name="reportEndDate" type="text"
                       style="width: 150px" value="<?php echo ($reportEndValue); ?>" AUTOCOMPLETE="off" /></li>
            <li>&nbsp;</li>
            <li>午别</li>
            ...
            <li><input id="reportViewHuizongBtn" name="reportViewBtn" type="button"
                       class="crmbutton small create" value=" 确  认  " />&nbsp;</li>
            <li>&nbsp;</li>

            <li><input id="reportExcelHuizongBtn" name="reportExcelBtn"
                       type="button" class="crmbutton small create" value="导出EXCEL"
                       onclick="outputTongjiExcel();" />&nbsp;</li>
            <li>&nbsp;</li>
            <li><input id="reportExcelHuizongBtn" name="reportExcelBtn"
                       type="button" class="crmbutton small create" value="打印"
