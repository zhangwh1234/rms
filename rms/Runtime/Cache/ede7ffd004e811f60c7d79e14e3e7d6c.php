<?php if (!defined('THINK_PATH')) exit();?><div class="moduleMenu">
    <ul>
        ...
        <li style="margin-left: 10px;"><a href="javascript:;" onclick="YingshouDoorBillEditviewModule.update();"><img src=".__PUBLIC__/Images/newBtn.png" alt="" title="" border="0"></a></li>
        <li><a href="javascript:void(0);" onclick="YingshouDoorBillEditviewModule.update();">保存订单<span>^9</span></a></li>
        <li style="width: 50px;">&nbsp;</li>
...
<form id="YingshouDoorBillEditviewForm" name="<?php echo ($moduleName); ?>EditviewForm" method="post" style="border:1px solid white;margin-top: 0px;">
...
<?php if(($uitype == 0)): ?><td width=20% class="dvtCellLabel" align=right><font color="red"><?php echo ($mandatory_field); ?></font><?php echo ($label); ?></td>
    ...
    <td width="100%" class="dvtCellLabel" align=center colspan="4">
        <table id="telAddressTable" width="90%" border=0 style="border: 1px solid #e0dddd; margin-top: 2px;"
            ...
            <?php if(empty($teladdress)): $__FOR_START_2065627592__=1;$__FOR_END_2065627592__=4;for($key=$__FOR_START_2065627592__;$key < $__FOR_END_2065627592__;$key+=1){ ?><tr style="height:25px;border: 1px solid black;background: #F0F0F0;" class="CaseRow">
...
<table id="<?php echo ($moduleName); echo (ucfirst(ACTION_NAME)); ?>productsTable" style="BORDER-COLLAPSE: collapse"  borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderproducts)): $__FOR_START_1577621747__=0;$__FOR_END_1577621747__=3;for($key=$__FOR_START_1577621747__;$key < $__FOR_END_1577621747__;$key+=1){ ?><tr>
...
<table id="orderPrintHandleTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderPrintHandle)): $__FOR_START_2056466639__=0;$__FOR_END_2056466639__=30;for($key=$__FOR_START_2056466639__;$key < $__FOR_END_2056466639__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
...
<table id="YingshouDoorBillAccountsTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%" align="center" border="1">
    ...
    <?php if(empty($doorbillaccounts)): $__FOR_START_777782640__=0;$__FOR_END_777782640__=3;for($key=$__FOR_START_777782640__;$key < $__FOR_END_777782640__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
                <td width="10%" align="center"> 
                    <input id="YingshouDoorBillAccountsCode_<?php echo ($key+1); ?>" name="accountsCode_<?php echo ($key+1); ?>" type="text" size="6" tabindex="1" onkeydown="YingshouDoorBillAccountsEditViewModule.getAccountsByCode(<?php echo ($key+1); ?>,event,this);"
                        AUTOCOMPLETE="off" style="font-size:16px;" />

                    <img id="YingshouDoorBillsearchIcon1" title="选择" src="./__PUBLIC__/Images/products.gif" style="cursor: pointer;" align="absmiddle" onclick="YingshouDoorBillAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>');" /><a
                        href="javascript:YingshouDoorBillAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>')">选择</a>
                </td>
                <td width="30%" align="center"> 
                    <input id="YingshouDoorBillAccountsName_<?php echo ($key+1); ?>" name="accountsName_<?php echo ($key+1); ?>" type="text" size="30" readonly="readonly" style="font-size:16px;" />
                </td>
                <td width="15%" align="center"> 
                    <input id="YingshouDoorBillAccountsMoney_<?php echo ($key+1); ?>" name="accountsMoney_<?php echo ($key+1); ?>" type="text" size="10" onkeydown="YingshouDoorBillAccountsEditViewModule.keydownSumAccountsMoney('<?php echo ($key+1); ?>',event,this);"
                        onblur="YingshouDoorBillAccountsEditViewModule.blurSumAccountsMoney();" tabindex="1" value="" style="font-size:16px;" />
                </td>
                <td width="25%" align="center"> 
                    <input id="YingshouDoorBillAccountsNote_<?php echo ($key+1); ?>" name="accountsNote_<?php echo ($key+1); ?>" type="text" size="30" onkeydown="YingshouDoorBillAccountsEditViewModule.keydownAccountsNote('<?php echo ($key+2); ?>',event);"
                        style="font-size:16px;" />
                </td>
                <td width="10%" align="center"><a href="#" onclick="YingshouDoorBillAccountsEditViewModule.clearAccounts(<?php echo ($key+1); ?>);">清空</a>
                </td>
            </tr><?php } endif; ?>
    <?php if(is_array($doorbillaccounts)): foreach($doorbillaccounts as $key=>$vo): ?><tr>
            <td width="5%" align="center"><?php echo ($key+1); ?></td>
            <td width="10%" align="center"> 
                <input id="YingshouDoorBillAccountsCode_<?php echo ($key+1); ?>" name="accountsCode_<?php echo ($key+1); ?>" type="text" size="6" tabindex="1" value="<?php echo ($vo["code"]); ?>" onkeydown="YingshouDoorBillAccountsEditViewModule.getAccountsByCode(<?php echo ($key+1); ?>,event,this);"
                    AUTOCOMPLETE="off" style="font-size:16px;" />
                <img id="YingshouDoorBillAccountssearchIcon1" title="客户选择" src="./__PUBLIC__/Images/products.gif" style="cursor: pointer;" align="absmiddle" onclick="YingshouDoorBillAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>');" /><a
                    href="javascript:YingshouDoorBillAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>')">选择</a>
            </td>
            <td width="30%" align="center"> 
                <input id="YingshouDoorBillAccountsName_<?php echo ($key+1); ?>" name="accountsName_<?php echo ($key+1); ?>" type="text" size="30" readonly="readonly" value="<?php echo ($vo["name"]); ?>" style="font-size:16px;" />
            </td>
            <td width="15%" align="center"> 
                <input id="YingshouDoorBillAccountsMoney_<?php echo ($key+1); ?>" name="accountsMoney_<?php echo ($key+1); ?>" type="text" size="10" onkeydown="YingshouDoorBillAccountsEditViewModule.keydownSumAccountsMoney();"
                    onblur="YingshouDoorBillAccountsEditViewModule.blurSumAccountsMoney();" tabindex="1" value="<?php echo ($vo["money"]); ?>" style="font-size:16px;" />
            </td>
            <td width="25%" align="center"> 
                <input id="YingshouDoorBillAccountsNote_<?php echo ($key+1); ?>" name="accountsNote_<?php echo ($key+1); ?>" type="text" size="30" value="<?php echo ($vo["note"]); ?>" style="font-size:16px;" />
            </td>
            <td width="10%" align="center"><a href="#" onclick="YingshouDoorBillAccountsEditViewModule.clearAccounts('<?php echo ($key+1); ?>');">清空</a>
            </td>
        </tr><?php endforeach; endif; ?>
...
<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%" align="center" border="1">
    <tr>
        <td class="accountsTableXiaojiLeftTd" width="65%">
            ...
            <input id="YingshouDoorBillAccountsLength" name="accountsLength" type="hidden" value="<?php echo ($key+1); ?>" />
        </td>
        ...
        <td class="accoutsTableXiaojiRightTd" style="font-size: 14px;"> 
            <span>小计</span>
            <input id="YingshouDoorBillAccountsTotalMoney" name="accountsTotalMoney" type="text" size="10" readonly="readonly" style="border: 0px;font-size: 14px;" value="<?php echo ($info["note"]); ?>" />
        </td>
    </tr>
</table>
...
<script>
    var YingshouDoorBillEditviewModule = {
        ...
        //保存记录
        update: function () {
            $('#YingshouDoorBillEditviewForm').form('submit', {
                url: '__URL__/update',
                onSubmit: function () {
                    //进行表单验证
                    if ($('#code').val() == '') {
    ...
    $(function () {
        $('#YingshouDoorBillEditviewForm input[name=code]').focus();
        YingshouDoorBillEditviewModule.init();
        setTimeout(function () {
