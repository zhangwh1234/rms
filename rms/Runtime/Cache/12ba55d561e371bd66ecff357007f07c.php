...
<table id="accountpaymentTable" width="100%" border="0" cellspacing="0" cellpadding="0" borderColor="white" border="1">
    ...
    <?php if(is_array($orderaccountpayment)): foreach($orderaccountpayment as $key=>$vo): ?><tr style="background-color: #F5F5F5;">
                <td width="5%" align="center" class="dvtCellLabel"><?php echo ($key+1); ?></td>
                <td width="10%" align="center" class="dvtCellLabel"> 
                    <span><?php echo ($vo["paymentid"]); ?></span>
                </td>
                <td width="30%" align="center" class="dvtCellLabel"> 
                    <span><?php echo ($vo["name"]); ?></span>
                </td>
    ...
    var OrderFormDetailviewModule = {
        ...
        quickKeyboardAction: function () {
            ...
            Mousetrap.bind(['ctrl+5', 'ctrl+f5', 'f5'], function (e) {
                ...
                var tabOptions = tab.panel('options');
                //if (tabOptions.title == '订餐单' ) {
                IndexIndexModule.updateOperateTab("__URL__/editview/record/<?php echo ($record); ?>/pagetype/<?php echo ($pagetype); ?>/rowIndex/<?php echo ($rowIndex); ?>");
                //};
            });
        }
    }
