<?php if (!defined('THINK_PATH')) exit();?><div class="moduleMenu">
    <ul>
        ...
        <li style="margin-left: 15px;"><a href="javascript:;" id="showSubMenu" onMouseOver=""><img src=".__PUBLIC__/Images/allpay.png"
        ...
        <li style="width: 50px;">&nbsp;</li>
        <li style="margin-left: 15px;"><a href="javascript:;" id="showSubMenu" onMouseOver=""><img src=".__PUBLIC__/Images/batchpay.png"
                    alt="" title="" border="0"></a></li>
    ...
    $(function () {
        ...
        $('#yingshouroomservice_checkorder_datagrid').datagrid({
            ...
            onExpandRow: function (index, row) {
                ...
                url = "__URL__/checkOrderGetPayment/ordersn/" + row.ordersn +
