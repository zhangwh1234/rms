...
<div class="moduleoperator">
    <form id="YingshouInnerCarryCreateviewForm" name="<?php echo ($moduleName); ?>CreateviewForm" method="post" style="border:1px solid white;margin-top: 0px;">
...
<?php if(($uitype == 0)): ?><td width=20% class="dvtCellLabel" align=right><font color="red"><?php echo ($mandatory_field); ?></font><?php echo ($label); ?></td>
    ...
    <td width="100%" class="dvtCellLabel" align=center colspan="4">
        <table id="telAddressTable" width="90%" border=0 style="border: 1px solid #e0dddd; margin-top: 2px;"
            ...
            <?php if(empty($teladdress)): $__FOR_START_166993228__=1;$__FOR_END_166993228__=4;for($key=$__FOR_START_166993228__;$key < $__FOR_END_166993228__;$key+=1){ ?><tr style="height:25px;border: 1px solid black;background: #F0F0F0;" class="CaseRow">
...
<table id="<?php echo ($moduleName); echo (ucfirst(ACTION_NAME)); ?>productsTable" style="BORDER-COLLAPSE: collapse"  borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderproducts)): $__FOR_START_1451898594__=0;$__FOR_END_1451898594__=3;for($key=$__FOR_START_1451898594__;$key < $__FOR_END_1451898594__;$key+=1){ ?><tr>
...
<table id="orderPrintHandleTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderPrintHandle)): $__FOR_START_1509612665__=0;$__FOR_END_1509612665__=30;for($key=$__FOR_START_1509612665__;$key < $__FOR_END_1509612665__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
          ...
          <input type="text" name="innercode" id="innercarryaccountcode" <?php echo ($readonly); ?> size="<?php echo ($length); ?>" class="detailedViewTextBox" onFocus="this.className='detailedViewTextBoxOn'"
              ...
              href="javascript:YingshouInnerCarryListviewModule.inneraccountsPickList('__URL__/popupInnerAccountsview/module/Accounts/row/<?php echo ($key+1); ?>')">选择</a>
                                ...
                                <tr style="line-height: 5px;">
                                    ...
                                    <input name="date" type="hidden" value="<?php echo ($currentDate); ?>" />
                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
