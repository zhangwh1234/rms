<?php if (!defined('THINK_PATH')) exit();?><div class="moduleMenu">
    <ul>
        ...
        <li style="margin-left: 10px;"><a href="javascript:;" onclick="<?php echo ($moduleName); ?>EditviewModule.update();"><img src=".__PUBLIC__/Images/newBtn.png" alt="" title="" border="0"></a></li>
        <li><a href="javascript:void(0);" onclick="<?php echo ($moduleName); ?>EditviewModule.update();">保存订单<span>^9</span></a></li>
        <li style="width: 50px;">&nbsp;</li>
        <li style="margin-left: 1px;"><a href="javascript:void(0);" onclick="IndexIndexModule.updateOperateTab('__URL__/listview')"><img src=".__PUBLIC__/Images/newBtn.png" alt="" title="" border="0"></a></li>
        <li><a href="javascript:void(0);" class="moduleName" onclick="IndexIndexModule.updateOperateTab('__URL__/listview');">返回列表 ^4</a></li>
...
<div class="moduleoperator" style="border: 1px solid white;">
    <form id="YingshouWorklunchEditviewForm" name="<?php echo ($moduleName); ?>EditviewForm" method="post" style="border:1px solid white;margin-top: 0px;">
...
<?php if(($uitype == 0)): ?><td width=20% class="dvtCellLabel" align=right><font color="red"><?php echo ($mandatory_field); ?></font><?php echo ($label); ?></td>
    ...
    <td width="100%" class="dvtCellLabel" align=center colspan="4">
        <table id="telAddressTable" width="90%" border=0 style="border: 1px solid #e0dddd; margin-top: 2px;"
            ...
            <?php if(empty($teladdress)): $__FOR_START_897445184__=1;$__FOR_END_897445184__=4;for($key=$__FOR_START_897445184__;$key < $__FOR_END_897445184__;$key+=1){ ?><tr style="height:25px;border: 1px solid black;background: #F0F0F0;" class="CaseRow">
...
<table id="<?php echo ($moduleName); echo (ucfirst(ACTION_NAME)); ?>productsTable" style="BORDER-COLLAPSE: collapse"  borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderproducts)): $__FOR_START_1581737246__=0;$__FOR_END_1581737246__=3;for($key=$__FOR_START_1581737246__;$key < $__FOR_END_1581737246__;$key+=1){ ?><tr>
...
<table id="orderPrintHandleTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <?php if(empty($orderPrintHandle)): $__FOR_START_183730121__=0;$__FOR_END_183730121__=30;for($key=$__FOR_START_183730121__;$key < $__FOR_END_183730121__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
...
<table id="YingshouWorklunchAccountsTable" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0"
       width="100%"
       align="center" border="1">
    ...
    <?php if(empty($worklunchaccounts)): $__FOR_START_999006135__=0;$__FOR_END_999006135__=3;for($key=$__FOR_START_999006135__;$key < $__FOR_END_999006135__;$key+=1){ ?><tr>
                <td width="5%" align="center"><?php echo ($key+1); ?></td>
                <td width="10%" align="center"> 
                    <input id="YingshouWorklunchAccountsCode_<?php echo ($key+1); ?>" name="accountsCode_<?php echo ($key+1); ?>" type="text"
                           size="6" tabindex="1"
                           onkeydown="YingshouWorklunchAccountsEditViewModule.getAccountsByCode(<?php echo ($key+1); ?>,event,this);"
                           AUTOCOMPLETE="off"
                           style="font-size:16px;"/>

                    <img id="YingshouWorklunchsearchIcon1" title="选择" src="./__PUBLIC__/Images/products.gif"
                         style="cursor: pointer;"
                         align="absmiddle"
                         onclick="YingshouWorklunchAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>');"/><a
                            href="javascript:YingshouWorklunchAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>')">选择</a>
                </td>
                <td width="30%" align="center"> 
                    <input id="YingshouWorklunchAccountsName_<?php echo ($key+1); ?>" name="accountsName_<?php echo ($key+1); ?>" type="text"
                           size="30"
                           readonly="readonly" style="font-size:16px;"/>
                </td>
                <td width="15%" align="center"> 
                    <input id="YingshouWorklunchAccountsMoney_<?php echo ($key+1); ?>" name="accountsMoney_<?php echo ($key+1); ?>" type="text"
                           size="10" onkeydown="YingshouWorklunchAccountsEditViewModule.keydownSumAccountsMoney('<?php echo ($key+1); ?>',event,this);"
                           onblur="YingshouWorklunchAccountsEditViewModule.blurSumAccountsMoney();"
                           tabindex="1" value="" style="font-size:16px;"/>
                </td>
                <td width="25%" align="center"> 
                    <input id="YingshouWorklunchAccountsNote_<?php echo ($key+1); ?>" name="accountsNote_<?php echo ($key+1); ?>" type="text"
                           size="30" onkeydown="YingshouWorklunchAccountsEditViewModule.keydownAccountsNote('<?php echo ($key+2); ?>',event);"
                            style="font-size:16px;"/>
                </td>
                <td width="10%" align="center"><a href="#"
                                                  onclick="YingshouWorklunchAccountsEditViewModule.clearAccounts(<?php echo ($key+1); ?>);">清空</a>
                </td>
            </tr><?php } endif; ?>
    <?php if(is_array($worklunchaccounts)): foreach($worklunchaccounts as $key=>$vo): ?><tr>
            <td width="5%" align="center"><?php echo ($key+1); ?></td>
            <td width="10%" align="center"> 
                <input id="YingshouWorklunchAccountsCode_<?php echo ($key+1); ?>" name="accountsCode_<?php echo ($key+1); ?>" type="text" size="6"
                       tabindex="1"
                       value="<?php echo ($vo["code"]); ?>"
                       onkeydown="YingshouWorklunchAccountsEditViewModule.getAccountsByCode(<?php echo ($key+1); ?>,event,this);"
                       AUTOCOMPLETE="off" style="font-size:16px;"/>
                <img id="YingshouWorklunchAccountssearchIcon1" title="客户选择" src="./__PUBLIC__/Images/products.gif"
                     style="cursor: pointer;"
                     align="absmiddle"
                     onclick="YingshouWorklunchAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>');"/><a
                        href="javascript:YingshouWorklunchAccountsEditViewModule.accountsPickList('__URL__/popupAccountsview/module/Accounts/row/<?php echo ($key+1); ?>')">选择</a>
            ...
            <td width="30%" align="center"> 
                <input id="YingshouWorklunchAccountsName_<?php echo ($key+1); ?>" name="accountsName_<?php echo ($key+1); ?>" type="text" size="30"
                       readonly="readonly"
                       value="<?php echo ($vo["name"]); ?>" style="font-size:16px;"/>
            </td>
            <td width="15%" align="center"> 
                <input id="YingshouWorklunchAccountsMoney_<?php echo ($key+1); ?>" name="accountsMoney_<?php echo ($key+1); ?>" type="text"
                       size="10" onkeydown="YingshouWorklunchAccountsEditViewModule.keydownSumAccountsMoney();"
                       onblur="YingshouWorklunchAccountsEditViewModule.blurSumAccountsMoney();"
                       tabindex="1" value="<?php echo ($vo["money"]); ?>" style="font-size:16px;"/>
            </td>
            <td width="25%" align="center"> 
                <input id="YingshouWorklunchAccountsNote_<?php echo ($key+1); ?>" name="accountsNote_<?php echo ($key+1); ?>" type="text" size="30"
...
<table width="100%" style="BORDER-COLLAPSE: collapse" borderColor="#CCCCCC" cellSpacing="0" width="100%"
    ...
    <tr>
        <td class="accountsTableXiaojiLeftTd" width="65%">
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icons-car_cart_basket-basket_add'"
               onclick="YingshouWorklunchAccountsEditViewModule.addAccounts();" style="font-size:16px;">添加项目</a>
            <a href="#" class="easyui-linkbutton" data-options="iconCls:'icons-car_cart_basket-basket_delete'"
               onclick="YingshouWorklunchAccountsEditViewModule.delAccounts();"
               style="font-size:16px;margin-left:30px;">删除项目最后一行</a>
            <input id="YingshouWorklunchAccountsLength" name="accountsLength" type="hidden" value="<?php echo ($key+1); ?>"/>
        </td>
        ...
        <td class="accoutsTableXiaojiRightTd" style="font-size: 14px;"> 
            <span>小计</span>
            <input id="YingshouWorklunchAccountsTotalMoney" name="accountsTotalMoney" type="text" size="10"
                   readonly="readonly"
                   style="border: 0px;font-size: 14px;" value="<?php echo ($info["note"]); ?>"/>
        </td>
    </tr>
</table>

<script type="text/javascript">
    var YingshouWorklunchAccountsEditViewModule = {
        ...
        addAccounts: function () {
            //取得表格行的长度
            var rowNum = $("#YingshouWorklunchAccountsTable tr").length;
            ...
            tableTrAppend += "<input class='easyui-numberbox' id='YingshouWorklunchAccountsCode_" + rowNum + "' name='accountsCode_" + rowNum + "'  type='text' size='6' tabindex='1' onkeyup='YingshouWorklunchAccountsEditViewModule.getAccountsByCode(" + rowNum + ",event,this)' style='font-size:16px;' />";
            tableTrAppend += "<img id='YingshouWorklunchsearchIcon1' title='客户选择' src='./" + PUBLIC + "/Images/products.gif' style='cursor: pointer;' align='absmiddle' onclick='YingshouWorklunchAccountsEditViewModule.accountsPickList(\"__URL__/popupAccountsview/module/Accounts/row/" + rowNum + "\");' />";
            tableTrAppend += "<a href='javascript:YingshouWorklunchAccountsEditViewModule.accountsPickList(\"__URL__/popupAccountsview/module/Accounts/row/" + rowNum + "\");' >选择</a>";
            tableTrAppend += "</td>";
            tableTrAppend += "<td width='30%' align='center' class='accountsTableLeftTd'>";
            tableTrAppend += "<input id='YingshouWorklunchAccountsName_" + rowNum + "' name='accountsName_" + rowNum + "' type='text' size='30'  style='font-size:16px;' readonly />";
            tableTrAppend += "</td>";
            tableTrAppend += "<td width='15%' align='center' class='accountsTableLeftTd'>";
            tableTrAppend += "<input id='YingshouWorklunchAccountsMoney_" + rowNum + "' name='accountsMoney_" + rowNum + "' type='text' size='10'   tabindex='1' value='' style='font-size:16px;' onkeydown=\"YingshouWorklunchAccountsEditViewModule.keydownSumAccountsMoney();\"\n" +
                "                       onblur=\"YingshouWorklunchAccountsEditViewModule.blurSumAccountsMoney();\" />";
            tableTrAppend += "</td>";
            tableTrAppend += "<td width='25%' align='center' class='accountsTableLeftTd'>";
            tableTrAppend += "<input id='YingshouWorklunchAccountsNote_" + rowNum + "' name='accountsNote_" + rowNum + "' type='text' size='30'  style='font-size:16px;'  />";
            tableTrAppend += "</td>";
            tableTrAppend += "<td width='10%' align='center' class='accountsTableLeftTd'><a href='#' onclick='YingshouWorklunchAccountsEditViewModule.clearAccounts(" + rowNum + ");' >清空</a></td>";
            tableTrAppend += "</tr>";
            $("#YingshouWorklunchAccountsTable").append(tableTrAppend);
            $("#YingshouWorklunchAccountsLength").attr("value", rowNum + 1);  //表格行数保存
        },
        ...
        keydownSumAccountsMoney: function (rowNum, evt, obj) {
            ...
            var key = evt.keyCode ? evt.keyCode : evt.which;
            if (key == 13) {
                if ($("#YingshouWorklunchAccountsName_" + rowNum).val() != '') {    //如果不为空，才计算
                    this.sumAccountsMoney(rowNum);
                }
                $("#YingshouWorklunchAccountsNote_" + rowNum).focus();
            }
            //向上移动一个
            if (key == 38) {
                var focusNum = rowNum - 1;
                if (focusNum > 0) {
                    $("#YingshouWorklunchAccountsCode_" + focusNum).focus();
                }
            }
            //向下移动
            if (key == 40) {
                $("#YingshouWorklunchAccountsCode_" + rowNum).focus();
            }
        },
        ...
        clearAccounts: function (rowNum) {
            var accountsCode = $("#YingshouWorklunchAccountsCode_" + rowNum).val();
            var accountsName = $("#YingshouWorklunchAccountsName_" + rowNum).val();

            if ((accountsCode == '') && (accountsName == '')) {
                return;
            }
            if (confirm("是否要清空内容")) {
                $("#YingshouWorklunchAccountsCode_" + rowNum).val('');
                $("#YingshouWorklunchAccountsName_" + rowNum).val('');
                $("#YingshouWorklunchAccountsMoney_" + rowNum).val('');
                $("#YingshouWorklunchAccountsNote_" + rowNum).val('');
                this.sumAccountsMoney(rowNum);
            }
        },
        ...
        delAccounts: function () {
            ...
            $("#YingshouWorklunchAccountsTable tr:last").remove();
            $("#YingshouWorklunchAccountsLength").attr("value", rowNum - 1);  //表格行数保存
            this.sumAccountsMoney(rowNum);
            ...
            $.ajax({
                ...
                success: function (mydata) {
                    ...
                    if (mydata) {
                        ...
                        for (i = 1; i < rowLength; i++) {
                            accountsName = $("YingshouWorklunchAccountsName_" + i).val();
                            if ((accountsName == mydata.name) && (i != rowNum)) {
                                alert('客户已经存在,不能添加！');
                                return;
                            }
                        }
                        $("#YingshouWorklunchAccountsName_" + rowNum).val(mydata.name);
                        //跳转到下一行
                        $("#YingshouWorklunchAccountsMoney_" + rowNum).focus();
                    } else {
        ...
        sumAccountsMoney: function (rowNum) {
            ...
            var totalMoney = 0;
            //取得表格行的长度
            var rowLength = $("#YingshouWorklunchAccountsTable tr").length;
            for (i = 1; i < rowLength; i++) {
                if ($("#YingshouWorklunchAccountsMoney_" + i).val() > 0) {
                    totalMoney = totalMoney + parseFloat($("#YingshouWorklunchAccountsMoney_" + i).val());
                }
            }
            $("#YingshouWorklunchAccountsTotalMoney").val(totalMoney);  //小计


            //写入总的金额
            totalMoney = totalMoney.toFixed(2);

            $('#YingshouWorklunchCreateviewForm input[name=money]').val(totalMoney);
            $('#YingshouWorklunchEditviewForm input[name=money]').val(totalMoney);
    ...
    var accountsAjax = false;  //判断是否查询过产品代码，防止在ajax中按回车，反复执行，有个alert的小bug
                            ...
                            <tr style="line-height: 5px;">
                                <td colspan="4" align="center">
                                    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icons-arrow-cross'" onclick="IndexIndexModule.updateOperateTab('__URL__/listview');" style="width:100px;">返回列表</a>
                                </td>
                            </tr>
                        </table>
...
<script>
    var YingshouWorklunchEditviewModule = {
        ...
        //保存记录
        update: function () {
            $('#YingshouWorklunchEditviewForm').form('submit', {
                url: '__URL__/update',
                onSubmit: function () {
                    //进行表单验证
                    if ($('#code').val() == '') {
    ...
    $(function () {
        $('#YingshouWorklunchEditviewForm input[name=content]').focus();
        YingshouWorklunchEditviewModule.init();
