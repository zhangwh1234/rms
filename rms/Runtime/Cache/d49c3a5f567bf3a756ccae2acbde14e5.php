...
<script>
    ...
    $(function () {
        ...
        $('body').on('click', '.city-list p', function () {
            ...
            saveHistory(data);
            code = findCode[data];
            $('#YingshouInnerCarryCreateviewForm input[name="innercode"]').val(code);
            $('#YingshouInnerCarryCreateviewForm input[name="inneraccount"]').val(data);
        ...
        $.ajax({
            type: "GET",
            url: "__URL__/getCompanyPayment/company/" + company,
            dataType: "json",
