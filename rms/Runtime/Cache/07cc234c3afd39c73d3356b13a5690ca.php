...
<div class="moduleOperator" style="border: 1px solid lightsteelblue; font-size: 16px;line-height: 20px;">
    <?php echo ($result); ?>
</div>

<script>
    var YingshouResultviewModule = {
        //初始化
        init: function () {
