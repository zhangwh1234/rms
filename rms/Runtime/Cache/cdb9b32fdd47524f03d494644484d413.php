<?php if (!defined('THINK_PATH')) exit();?><div class="moduleMenu">
    <ul>
        ...
        <li style="margin-left: 10px;"><a href="javascript:;" onclick="<?php echo ($moduleName); ?>EditviewModule.update();"><img
...
<div class="moduleoperator">
    <form id="<?php echo ($moduleName); ?>EditviewForm" name="<?php echo ($moduleName); ?>EditviewForm" method="POST" style="border: 1px solid white;"  >
                            ...
                            <tr>
                                <td colspan="4" align="center">
                                    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icons-other-tick'"
                                       onclick="<?php echo ($moduleName); ?>EditviewModule.update();" style="width:100px;margin-right:40px;">确认</a>
...
<script>
    var PaymentMgrEditviewModule = {
        ...
        //保存记录
        update: function () {
            $('#PaymentMgrEditviewForm').form('submit', {
                url: '__URL__/update',
                onSubmit: function () {
                    //进行表单验证
                    if($('#code').val() == ''){
