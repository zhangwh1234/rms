<?php if (!defined('THINK_PATH')) exit();?><div class="moduleMenu">
    <ul>
        ...
        <li>
            <a href="javascript:void(0);" onclick="IndexIndexModule.updateOperateTab('__URL__/listview');">&nbsp;&gt;<?php echo (L("$moduleName")); ?></a>
        </li>
        <li>&nbsp;&gt;列表操作</li>
        <li style="width: 30px;">&nbsp;</li>
                    ...
                    <div class="easyui-panel" style="width:100%;max-width:400px;padding:2px 60px 0px 60px;">
                        ...
                        <!--
                            ...
                            <select name="ElectronInvoicecompanyselect" id="ElectronInvoicecompanyselect" style="width:100%">
                                <option>全部</option>
                                <?php if(is_array($companySelect)): foreach($companySelect as $key=>$vo): ?><option><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                            </select>
                ...
                <li style="margin-left: 20px;">
                    <input type="text" id="ElectronInvoiceReportListviewDateInput" class="easyui-datebox" name="ElectronInvoiceReportListviewDateInput" style="font-size: 16px;width:150px;" value="<?php echo ($getDate); ?>" />
                </li>
