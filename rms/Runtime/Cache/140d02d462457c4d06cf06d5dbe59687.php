...
<script type="text/javascript">
    ...
    var YingshouRoomServicePopupAccountsviewModule = {
        ...
        operate: function (val, rowData, rowIndex) {
            var btn = [];
            btn.push('<a href="javascript:void(0);" onclick="OrderFormPopupProductsviewModule.selectProducts(' + rowData.productsid+','+rowData.code+',\''
