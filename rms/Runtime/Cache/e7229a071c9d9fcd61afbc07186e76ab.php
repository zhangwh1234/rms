...
<script>
    ...
    $(function () {
        ...
        $('body').on('click', '.city-list p', function () {
                ...
                $("#YingshouRoomServiceAccountsName_" + row).val(data); //返回产品名称 
                YingshouRoomServiceAccountsEditViewModule.getAccounts(row,code);
                //$("#YingshouRoomServiceAccountsCode_" +row).focus(); 
