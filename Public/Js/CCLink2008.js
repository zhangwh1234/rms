...
TCCLink.prototype.Link_ConnectServer = function (Host, Port, SynchronizationTime) {
    ...
    if (Host.indexOf(":") >= 0) {
        CCServerHost = Host;
        this.CCLinkUrl = "http://19.134.125.130:" + Port + "/";
    }
    else {
...
TCCLink.prototype.Ext_Dassign = function (ExtCode) {
    if (this.CCLinkState == 0) {
        return;
    }
    if (ExtCode == "*") {
...
TCCLink.prototype.Queue_GetExtCodeList = function (QueueCode, Separator) {
    ...
    if (this.CCLinkState != 0) {
        var QueueIndex = this.QueueIndexByCode(QueueCode);
        if (QueueIndex != -1) {
            for (var fori = 0; fori < CCLinkQueueList[QueueIndex].ExtList.length; fori++) {
                if (sResult == "") {
...
TCCLink.prototype.Queue_GetUserCount = function (QueueCode) {
    ...
    if (this.CCLinkState != 0) {
        var QueueIndex = this.QueueIndexByCode(QueueCode);
        if (QueueIndex != -1) {
            iResult = this.CCLinkUserList[QueueIndex].UserList.length;
        }
    }
    return iResult;
}
...
TCCLink.prototype.MeetingRoom_Dassign = function (MeetingRoomCode) {
    if (this.CCLinkState == 0) {
        return;
    }
    if (MeetingRoomCode == "*") {
